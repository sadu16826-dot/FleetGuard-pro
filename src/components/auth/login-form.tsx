...
export function LoginForm() {
  ...
  return <form onSubmit={submit} className="mt-8 space-y-5">
    <div><label htmlFor="username" className="mb-2 block text-sm font-medium text-slate-700">Username or email</label><Input id="username" name="username" placeholder="Enter username or email" autoComplete="username" required autoFocus/></div>
